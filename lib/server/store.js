...
function buildPublicCalendar(state, options = {}) {
  ...
  for (let offset = 0; offset < days; offset += 1) {
    ...
    const suitablePainters = state.painters.filter((painter) => {
      ...
      // Public web nesmí po čistém resetu "spadnout" do nulové dostupnosti jen proto,
      // že si malíři ještě ručně neoznačili kalendář. Unknown zde bereme jako výchozí volno.
      if (effectiveStatus === UNKNOWN_AVAILABILITY_STATUS) return true
