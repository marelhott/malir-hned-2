...
// ── MALÍŘI ────────────────────────────────────────────────────
const PM = {
  'Marek':   { name: 'Marek',   ini: 'M', exp: '30 let praxe', role: 'Byty a běžné výmalby', summary: 'Nejlépe sedí na klasické bytové zakázky, kde je důležitá pečlivá příprava, čistá práce a klidná domluva.', price: '10 000–18 000 Kč', resp: 'Volá do 20 min', jobs: '560 zakázek', spec: ['Byty', 'Běžná výmalba', 'Pečlivá příprava'], fit: 'Spolehlivá volba pro standardní bytové zakázky.', img: 'uploads/marek.jpeg', imgPos: 'center 0%' },
  'Vincent': { name: 'Vincent', ini: 'V', exp: '5–7 let praxe', role: 'Novostavby a větší byty', summary: 'Sedí mi čisté zakázky, které se dají dobře naplánovat dopředu. Mám rád přesný rozsah práce a klidnou organizaci.', price: '14 000–25 000 Kč', resp: 'Volá do 25 min', jobs: '198 zakázek', spec: ['Novostavby', '3+kk a větší', 'Stropy'], fit: 'Silný na větší zakázky, kde se plánuje dopředu.', img: 'uploads/vincent.jpeg', imgPos: 'center 0%' },
  'Martin':  { name: 'Martin',  ini: 'M', exp: '3–5 let praxe', role: 'Přesné zakrytí a detail', summary: 'Víc než rychlost řeším pečlivost. Hodím se tam, kde je důležité šetrné zakrytí a čistý detail kolem nábytku nebo kuchyně.', price: '12 000–20 000 Kč', resp: 'Volá do 31 min', jobs: '127 zakázek', spec: ['Detailní práce', 'Zakrytí nábytku', 'Barevné malby'], fit: 'Dobrý tam, kde hraje roli detail a pečlivost.', img: 'uploads/martin.jpeg', imgPos: 'center 0%' },
  'Lenka':   { name: 'Lenka',   ini: 'L', exp: '3–5 let praxe', role: 'Rychlé termíny', summary: 'Když je potřeba rychle vymalovat menší byt nebo kancelář, umím se přizpůsobit tempu a fungovat i v kratším okně.', price: '7 500–15 000 Kč', resp: 'Volá do 12 min', jobs: '173 zakázek', spec: ['Menší byty', 'Kanceláře', 'Do 48 hodin'], fit: 'Nejlepší volba pro urgentní menší zakázky.', img: 'uploads/lenka.jpeg', imgPos: 'center 0%' },
  'Albert':  { name: 'Albert',  ini: 'A', exp: '5–7 let praxe', role: 'Po nájemníkovi a menší byty', summary: 'Nejčastěji maluju byty před nastěhováním a rychlé přemalby, kde je důležitá jasná domluva a čistá práce bez zbytečných okolků.', price: '9 000–16 000 Kč', resp: 'Volá do 18 min', jobs: '286 zakázek', spec: ['Po nájemníkovi', '1+kk až 3+1', 'Rychlé termíny'], fit: 'Ideální pro menší byty a rychlé přemalby.', img: 'uploads/albert.jpeg', imgPos: 'center 0%' },
  'Pavel':   { name: 'Pavel',   ini: 'P', exp: '3–5 let praxe', role: 'Přemalby a opravy', summary: 'Dělám běžné přemalby i stěny, které potřebují před malbou srovnat a připravit. Hodí se tam, kde je potřeba opravit drobnosti.', price: '8 000–18 000 Kč', resp: 'Volá do 22 min', jobs: '244 zakázek', spec: ['Opravy stěn', 'Přemalby', 'Starší byty'], fit: 'Výborný tam, kde nejsou stěny úplně v top stavu.', img: 'uploads/pavel.jpeg', imgPos: 'center 0%' },
};
...
const MONTHS = [
  {
    ...
    cal: [
      { d:  1, jobs: [{ p: 'Albert',     t: '9:00'  }, { p: 'Pavel',   t: '13:30' }] },
      { d:  2, jobs: [{ p: 'Lenka',  t: '8:00'  }, { p: 'Vincent', t: '14:00' }] },
      { d:  3, jobs: [{ p: 'Pavel',   t: '11:00' }] },
      { d:  4, jobs: [{ p: 'Vincent', t: '10:00' }, { p: 'Martin',    t: '15:00' }] },
      { d:  5, jobs: [] }, { d: 6, jobs: [] },
      { d:  7, jobs: [{ p: 'Albert',     t: '8:30'  }, { p: 'Lenka',  t: '12:30' }] },
      { d:  8, jobs: [{ p: 'Lenka',  t: '9:00'  }, { p: 'Pavel',   t: '13:00' }] },
      { d:  9, jobs: [{ p: 'Pavel',   t: '10:00' }, { p: 'Martin',    t: '15:00' }] },
      { d: 10, jobs: [{ p: 'Albert',     t: '8:30'  }, { p: 'Vincent', t: '12:00' }, { p: 'Lenka', t: '15:30' }] },
      { d: 11, jobs: [{ p: 'Martin',    t: '9:00'  }, { p: 'Vincent', t: '14:30' }] },
      { d: 12, jobs: [] }, { d: 13, jobs: [{ p: 'Pavel', t: '8:00' }, { p: 'Lenka', t: '13:30' }] },
      { d: 14, jobs: [] },
      { d: 15, jobs: [{ p: 'Lenka',  t: '9:30'  }, { p: 'Vincent', t: '12:00' }] },
      { d: 16, jobs: [{ p: 'Albert',     t: '10:00' }] },
      { d: 17, jobs: [{ p: 'Vincent', t: '11:00' }, { p: 'Martin',    t: '14:30' }] },
      { d: 18, jobs: [{ p: 'Albert',     t: '7:00'  }] },
      { d: 19, jobs: [] }, { d: 20, jobs: [{ p: 'Lenka', t: '9:00' }] },
      { d: 21, jobs: [{ p: 'Vincent', t: '11:30' }, { p: 'Martin', t: '15:00' }] },
      { d: 22, jobs: [{ p: 'Lenka',  t: '9:00'  }, { p: 'Pavel',   t: '13:30' }] },
      { d: 23, jobs: [{ p: 'Vincent', t: '10:00' }] },
      { d: 24, jobs: [{ p: 'Albert',     t: '8:30'  }, { p: 'Pavel',   t: '15:30' }] },
      { d: 25, jobs: [] }, { d: 26, jobs: [] },
      { d: 27, jobs: [{ p: 'Lenka',  t: '9:00'  }] },
      { d: 28, jobs: [{ p: 'Vincent', t: '11:00' }] },
      { d: 29, jobs: [{ p: 'Pavel',   t: '9:30'  }] },
      { d: 30, jobs: [{ p: 'Martin',    t: '10:30' }] },
    ]
  },
  {
    ...
    cal: [
      ...
      { d:  4, jobs: [{ p: 'Albert',     t: '9:00'  }, { p: 'Pavel',   t: '14:00' }] },
      { d:  5, jobs: [{ p: 'Lenka',  t: '8:30'  }] },
      { d:  6, jobs: [{ p: 'Vincent', t: '10:00' }, { p: 'Martin',    t: '15:00' }] },
      { d:  7, jobs: [{ p: 'Pavel',   t: '9:00'  }, { p: 'Albert',     t: '13:30' }] },
      { d:  8, jobs: [{ p: 'Lenka',  t: '11:00' }, { p: 'Vincent', t: '15:00' }] },
      { d:  9, jobs: [] }, { d: 10, jobs: [] },
      { d: 11, jobs: [{ p: 'Albert',     t: '8:00'  }, { p: 'Martin',    t: '13:00' }, { p: 'Pavel', t: '16:00' }] },
      { d: 12, jobs: [{ p: 'Pavel',   t: '9:30'  }] },
      { d: 13, jobs: [{ p: 'Vincent', t: '10:00' }, { p: 'Lenka',  t: '14:30' }] },
      { d: 14, jobs: [{ p: 'Albert',     t: '8:30'  }] },
      { d: 15, jobs: [{ p: 'Martin',    t: '9:00'  }, { p: 'Pavel',   t: '13:00' }] },
      { d: 16, jobs: [] }, { d: 17, jobs: [] },
      { d: 18, jobs: [{ p: 'Lenka',  t: '8:00'  }, { p: 'Vincent', t: '12:00' }] },
      { d: 19, jobs: [{ p: 'Albert',     t: '10:00' }] },
      { d: 20, jobs: [{ p: 'Pavel',   t: '9:00'  }, { p: 'Martin',    t: '14:00' }] },
      { d: 21, jobs: [{ p: 'Vincent', t: '11:00' }] },
      { d: 22, jobs: [{ p: 'Lenka',  t: '8:30'  }, { p: 'Albert',     t: '13:30' }] },
      { d: 23, jobs: [] }, { d: 24, jobs: [] },
      { d: 25, jobs: [{ p: 'Martin',    t: '9:00'  }, { p: 'Pavel',   t: '14:00' }] },
      { d: 26, jobs: [{ p: 'Albert',     t: '10:00' }] },
      { d: 27, jobs: [{ p: 'Vincent', t: '9:00'  }, { p: 'Lenka',  t: '13:00' }] },
      { d: 28, jobs: [{ p: 'Pavel',   t: '11:00' }] },
      { d: 29, jobs: [{ p: 'Albert',     t: '8:30'  }, { p: 'Martin',    t: '15:00' }] },
      { d: 30, jobs: [] }, { d: 31, jobs: [] },
    ]
  },
  {
    ...
    cal: [
      { d:  1, jobs: [{ p: 'Vincent', t: '9:00'  }, { p: 'Lenka',  t: '14:00' }] },
      { d:  2, jobs: [{ p: 'Pavel',   t: '10:00' }] },
      { d:  3, jobs: [{ p: 'Albert',     t: '9:30'  }, { p: 'Martin',    t: '14:30' }] },
      { d:  4, jobs: [{ p: 'Lenka',  t: '8:00'  }, { p: 'Vincent', t: '13:00' }] },
      { d:  5, jobs: [{ p: 'Pavel',   t: '11:00' }] },
      { d:  6, jobs: [] }, { d: 7, jobs: [] },
      { d:  8, jobs: [{ p: 'Albert',     t: '9:00'  }, { p: 'Pavel',   t: '13:30' }, { p: 'Lenka', t: '16:00' }] },
      { d:  9, jobs: [{ p: 'Vincent', t: '10:00' }] },
      { d: 10, jobs: [{ p: 'Martin',    t: '9:00'  }, { p: 'Albert',     t: '14:00' }] },
      { d: 11, jobs: [{ p: 'Lenka',  t: '8:30'  }] },
      { d: 12, jobs: [{ p: 'Pavel',   t: '10:00' }, { p: 'Vincent', t: '15:00' }] },
      { d: 13, jobs: [] }, { d: 14, jobs: [] },
      { d: 15, jobs: [{ p: 'Albert',     t: '9:00'  }, { p: 'Martin',    t: '13:00' }] },
      { d: 16, jobs: [{ p: 'Lenka',  t: '8:00'  }] },
      { d: 17, jobs: [{ p: 'Vincent', t: '10:00' }, { p: 'Pavel',   t: '14:30' }] },
      { d: 18, jobs: [{ p: 'Albert',     t: '9:30'  }] },
      { d: 19, jobs: [{ p: 'Martin',    t: '11:00' }, { p: 'Lenka',  t: '15:30' }] },
      { d: 20, jobs: [] }, { d: 21, jobs: [] },
      { d: 22, jobs: [{ p: 'Pavel',   t: '9:00'  }, { p: 'Vincent', t: '13:00' }] },
      { d: 23, jobs: [{ p: 'Albert',     t: '10:00' }] },
      { d: 24, jobs: [{ p: 'Lenka',  t: '8:30'  }, { p: 'Martin',    t: '14:00' }] },
      { d: 25, jobs: [{ p: 'Pavel',   t: '9:00'  }] },
      { d: 26, jobs: [{ p: 'Vincent', t: '11:00' }, { p: 'Albert',     t: '15:00' }] },
      { d: 27, jobs: [] }, { d: 28, jobs: [] },
      { d: 29, jobs: [{ p: 'Albert',     t: '9:00'  }, { p: 'Pavel',   t: '13:30' }] },
      { d: 30, jobs: [{ p: 'Lenka',  t: '10:00' }] },
    ]
  },
];
